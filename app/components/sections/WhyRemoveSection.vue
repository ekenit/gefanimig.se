<template>
  ...
  <section
    class="py-12 bg-gradient-to-r from-gray-50/80 to-blue-50/60 dark:from-gray-800/40 dark:to-blue-950/20"
  >
      ...
      <div class="mx-auto max-w-4xl">
         <Card variant="glass"
          ...
          <div class="text-center mb-8">
            ...
            <div
              class="inline-flex items-center justify-center w-12 h-12 mb-4 rounded-full bg-blue-100 dark:bg-blue-900/30"
            >
               <Icon
          ...
          <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
             ...
             <Card
              variant="default"
              padding="sm"
              class="bg-blue-50/50 dark:bg-blue-900/20 border-blue-200/50 dark:border-blue-800/50"
              >
              <p

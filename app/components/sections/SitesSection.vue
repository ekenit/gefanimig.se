      ...
      <div class="mx-auto max-w-4xl px-4">
        <div class="text-center mb-12">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300">
            Följ dessa enkla steg för att ta bort dina uppgifter från svenska databaser
          </p>
        </div>
          ...
          >
            <div class="flex items-start justify-between gap-6">
              <div class="flex-1 min-w-0">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-4 pl-11">{{ site.method }}</p>
                
                <!-- Email display for non-form sites -->
                <div v-if="site.email && !site.method.includes('webbformulär')" class="pl-11 mb-4">
              ...
              <div v-if="!site.method.toLowerCase().includes('bankid')" class="flex-shrink-0 w-72">
                <div class="bg-yellow-50/80 dark:bg-yellow-900/20 border border-yellow-200/60 dark:border-yellow-800/60 rounded-xl p-4">
                  <div class="flex items-start space-x-3">
                    <div class="flex-shrink-0 w-8 h-8 bg-yellow-100 dark:bg-yellow-900/40 rounded-lg flex items-center justify-center">
                      <Icon name="heroicons:information-circle" class="h-4 w-4 text-yellow-600 dark:text-yellow-400" />
                    </div>
                    <div class="min-w-0">

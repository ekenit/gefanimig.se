  ...
  <section class="py-16">
    ...
    <div class="px-4 mx-auto max-w-7xl">
      ...
      <div class="mx-auto max-w-4xl px-4">
        ...
        <div class="space-y-8">
           <!-- Google Removal --> <Card variant="glass" hoverable
            >
            <div class="flex items-start space-x-4">

              <div
                class="flex-shrink-0 w-12 h-12 bg-red-100 dark:bg-red-900/20 rounded-xl flex items-center justify-center"
              >
                 <Icon
              ...
              <div class="flex-1 space-y-4">
                ...
                <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                 ...
                 <Card
                  ...
                  <div
                    class="bg-white dark:bg-gray-800 rounded-lg p-4 text-sm font-mono text-gray-800 dark:text-gray-200 border"
                  >
                    ...
                    <p>
                      ...
                      Erasure) of the GDPR. The information is no longer
                      necessary for the purposes for which it was originally
                      collected or processed, and its continued publication is
                      not justified by any overriding legitimate interest, thus
                      requiring its removal to comply with EU data protection
                      laws.
                    </p>
                ...
                > <Button
                  ...
                  > Google-formulär för borttagning </Button
                >
              </div>

            </div>
             </Card
          > <!-- Address Protection --> <Card variant="glass" hoverable
            >
            <div class="flex items-start space-x-4">

              <div
                class="flex-shrink-0 w-12 h-12 bg-green-100 dark:bg-green-900/20 rounded-xl flex items-center justify-center"
              >
                 <Icon
                  name="heroicons:home"

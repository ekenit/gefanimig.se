<template>
  ...
  <div :class="cardClasses">
    ...
    <div v-if="$slots.footer" class="p-6 pt-0"> <slot name="footer" /> </div>
...
const cardClasses = computed(() => {
  ...
  const variantClasses = {
    default:
      'bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-gray-200/50 dark:border-gray-700/50 shadow-sm',
    glass:
      'bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border-gray-200/30 dark:border-gray-700/30 shadow-lg',
  }

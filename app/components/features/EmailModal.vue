            ...
            <div class="p-6">
              ...
              <div class="flex items-center justify-between mb-6">
                 <DialogTitle class="text-xl font-bold"
                  > Skapa e-postmall till {{ currentSite?.name }} </DialogTitle
                > <Button
                  variant="ghost"
                  size="sm"
              ...
              <div class="mb-6">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                   Anpassa mallen innan du kopierar den eller skickar ett
                  e-postmeddelande.
                </p>
                ...
                <div class="flex items-start space-x-3">
                  ...
                  <div class="text-sm">
                    ...
                    <p class="text-blue-800 dark:text-blue-200">
                       Ersätt <strong>"Förnamn Efternamn"</strong> och
                      <strong>"Personnummer"</strong> med dina egna uppgifter
                      innan du skickar.
                    </p>
